...
`
	expectedNxos2Metrics = map[string]float64{
		...
		prefix + "powersupply_operational_info{model=NXA-PAC-650W-PI,supply=1,target=test.test}":                1,
		prefix + "powersupply_operational_info{model=NXA-PAC-650W-PI,supply=2,target=test.test}":                1,
		prefix + "powersupply_redundancy_configured_info{target=test.test}":                                     1,
		prefix + "powersupply_redundancy_opererational_info{target=test.test}":                                  1,
		prefix + "powersupply_voltage_volts{target=test.test}":                                                  12,
...
`
	...
	expectedIos1Metrics = map[string]float64{
		...
		prefix + "fan_operational_status_info{fan= ps-1,target=test.test}":                             1,
		prefix + "fan_operational_status_info{fan= ps-2,target=test.test}":                             1,
		prefix + "powersupply_operational_info{powersupply=power supply 1,target=test.test}":           1,
		prefix + "powersupply_operational_info{powersupply=power supply 2,target=test.test}":           1,
